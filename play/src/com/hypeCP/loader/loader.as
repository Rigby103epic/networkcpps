class com.hypeCP.loader.loader
{
    ...
    function loader(arg)
    {
        ...
        _global.baseURL = "http://penguinelite.sytes.net/";
        System.security.allowDomain("*");
        loadMovieNum("http://penguinelite.sytes.net/play/v2/client/load.swf?cp1356", 1);
        _root.onEnterFrame = function ()
        {
            for (var _loc11 in _level1)
            {
                ...
                {
                    _level1.bootLoader.messageFromAS3({type: "setEnvironmentData", data: {clientPath: "http://penguinelite.sytes.net/play/v2/client/", contentPath: "http://penguinelite.sytes.net/play/v2/content/", gamesPath: "http://penguinelite.sytes.net/play/v2/games/", connectionID: "hype127", language: "en", basePath: "", affiliateID: "0"}});
                    _root.onEnterFrame = function ()
                    {
    ...
    function addServer(name, ip, port, population)
    {
        ...
        ++_loc1;
        trace (_loc1);
        _level0.CLIENT.PENGUIN.SHELL.world_crumbs[_loc1] = {name: "Frosty Fields", ip: "127.0.0.1", port: "9875", id: _loc1, population: population};
    } // End of the function
